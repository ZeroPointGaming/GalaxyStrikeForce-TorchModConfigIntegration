...
namespace GSF.Settings.Aegis_Small_Beam_Base
{
    //"Aegis_Small_Beam_Base == ASBB"
    /// <summary>
    ...
    /// </summary>
    public static class ASBB_Default_Settings
    {

        public static BeamWeaponDefaultInfo Aegis_Small_Beam_Base = new BeamWeaponDefaultInfo(
    ...
    /// </summary>
    public static class ASBB_Color_Settings
    {
        public static BeamWeaponColorInfo Aegis_Small_Beam_Base = new BeamWeaponColorInfo(
    ...
    /// </summary>
    public static class ASBB_Heat_Settings
    {
        public static BeamWeaponExtendedHeatInfo Aegis_Small_Beam_Base = new BeamWeaponExtendedHeatInfo(
    ...
    /// 
    /// </summary>
    public static class ASBB_Default_Ui_Settings
    {

        public static BeamWeaponUiInfo Aegis_Small_Beam_Base = new BeamWeaponUiInfo(
    ...
    /// </summary>
    public static class ASBB_Custom_Ui_Settings
    {
        public class Toggle
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponToggle ASBB_PowerOveride = new BeamWeaponCustomUiInfo.BeamWeaponToggle(
        ...
        public class Slider
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider ASBB_RangeSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider ASBB_CurrentSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider ASBB_ModulationSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider ASBB_PowerSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
    ...
    /// </summary>
    public static class ASBB_Barrel_Settings
    {
        public static class Aegis_Small_Beam_Base
        {
        ...
        public static class ASBB_Targeting_Beam
        {

...
namespace GSF.Settings.XLarge_Giga_Beam
{
    //"GSF_XLarge_Giga_Beam == WT"
    /// <summary>
    ...
    /// </summary>
    public static class XLGB_Default_Settings
    {

        public static BeamWeaponDefaultInfo XLarge_Giga_Beam = new BeamWeaponDefaultInfo(
    ...
    /// </summary>
    public static class XLGB_Color_Settings
    {
        public static BeamWeaponColorInfo XLarge_Giga_Beam = new BeamWeaponColorInfo(
    ...
    /// </summary>
    public static class XLGB_Heat_Settings
    {
        public static BeamWeaponExtendedHeatInfo XLarge_Giga_Beam = new BeamWeaponExtendedHeatInfo(
    ...
    /// 
    /// </summary>
    public static class XLGB_Default_Ui_Settings
    {

        public static BeamWeaponUiInfo XLarge_Giga_Beam = new BeamWeaponUiInfo(
    ...
    /// </summary>
    public static class XLGB_Custom_Ui_Settings
    {
        public class Toggle
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponToggle XLGB_PowerOveride = new BeamWeaponCustomUiInfo.BeamWeaponToggle(
        ...
        public class Slider
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider XLGB_RangeSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider XLGB_CurrentSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider XLGB_ModulationSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider XLGB_PowerSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
    ...
    /// </summary>
    public static class XLGB_Barrel_Settings
    {
        public static class XLarge_Giga_Beam
        {
            //Left Beam
            public static BeamWeaponBarrelSubpartInfo B1 = new BeamWeaponBarrelSubpartInfo(
            17.55d,  //Forward Origin
        ...
        public static class XLGB_Targeting_Beam
        {

...
/// </summary>
namespace GSF.Settings.Weapon_Template
{
    //"Weapon_Template == WT"
    /// <summary>
    ...
    public static class Default_Settings
    {
        ...
        public static BeamWeaponDefaultInfo Weapon_Template = new BeamWeaponDefaultInfo(
    ...
    {
        public static BeamWeaponColorInfo Weapon_Template = new BeamWeaponColorInfo(
    ...
    /// </summary>
    public static class Heat_Settings
    {
        public static BeamWeaponExtendedHeatInfo Weapon_Template = new BeamWeaponExtendedHeatInfo(
    ...
    /// 
    /// </summary>
    public static class Default_Ui_Settings
    {

        public static BeamWeaponUiInfo Weapon_Template = new BeamWeaponUiInfo(
    ...
    /// </summary>
    public static class Custom_Ui_Settings
    {
        public class Toggle
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponToggle WT_PowerOveride = new BeamWeaponCustomUiInfo.BeamWeaponToggle(
        ...
        public class Slider
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider WT_RangeSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider WT_CurrentSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider WT_ModulationSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider WT_PowerSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
    ...
    /// </summary>
    public static class Barrel_Settings
    {
        public static class Weapon_Template
        {

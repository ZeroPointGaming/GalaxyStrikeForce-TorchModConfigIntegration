...
namespace GSF.Settings.Medium_Pulse
{
    //"Weapon_Template == WT"
    /// <summary>
    ...
    /// </summary>
    public static class MP_Default_Settings
    {

        public static BeamWeaponDefaultInfo Medium_Pulse = new BeamWeaponDefaultInfo(
    ...
    /// </summary>
    public static class MP_Color_Settings
    {
        public static BeamWeaponColorInfo Medium_Pulse = new BeamWeaponColorInfo(
    ...
    /// </summary>
    public static class MP_Heat_Settings
    {
        public static BeamWeaponExtendedHeatInfo Medium_Pulse = new BeamWeaponExtendedHeatInfo(
    ...
    /// 
    /// </summary>
    public static class MP_Default_Ui_Settings
    {

        public static BeamWeaponUiInfo Medium_Pulse = new BeamWeaponUiInfo(
    ...
    /// </summary>
    public static class MP_Custom_Ui_Settings
    {
        public class Toggle
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponToggle MP_PowerOveride = new BeamWeaponCustomUiInfo.BeamWeaponToggle(
        ...
        public class Slider
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider MP_RangeSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider MP_CurrentSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider MP_ModulationSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider MP_PowerSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
    ...
    /// </summary>
    public static class MP_Barrel_Settings
    {
        public static class Medium_Pulse
        {
        ...
        public static class MP_Targeting_Beam
        {

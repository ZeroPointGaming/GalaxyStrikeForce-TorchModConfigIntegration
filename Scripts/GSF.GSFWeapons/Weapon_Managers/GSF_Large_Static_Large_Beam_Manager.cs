...
namespace GSF.Settings.Large_Static_Large_Beam
{
    //"Large_Static_Large_Beam == LSLB"
    /// <summary>
    ...
    /// </summary>
    public static class LSLB_Default_Settings
    {

        public static BeamWeaponDefaultInfo Large_Static_Large_Beam = new BeamWeaponDefaultInfo(
    ...
    /// </summary>
    public static class LSLB_Color_Settings
    {
        public static BeamWeaponColorInfo Large_Static_Large_Beam = new BeamWeaponColorInfo(
    ...
    /// </summary>
    public static class LSLB_Heat_Settings
    {
        public static BeamWeaponExtendedHeatInfo Large_Static_Large_Beam = new BeamWeaponExtendedHeatInfo(
    ...
    /// 
    /// </summary>
    public static class LSLB_Default_Ui_Settings
    {

        public static BeamWeaponUiInfo Large_Static_Large_Beam = new BeamWeaponUiInfo(
    ...
    /// </summary>
    public static class LSLB_Custom_Ui_Settings
    {
        public class Toggle
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponToggle LSLB_PowerOveride = new BeamWeaponCustomUiInfo.BeamWeaponToggle(
        ...
        public class Slider
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider LSLB_RangeSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider LSLB_CurrentSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider LSLB_ModulationSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider LSLB_PowerSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
    ...
    /// </summary>
    public static class LSLB_Barrel_Settings
    {
        public static class Large_Static_Large_Beam
        {
            public static BeamWeaponBarrelSubpartInfo B1 = new BeamWeaponBarrelSubpartInfo(
            9.45d,  //Forward Origin
        ...
        public static class LSSB_Targeting_Beam
        {
            public static BeamWeaponBarrelSubpartInfo B1 = new BeamWeaponBarrelSubpartInfo(
            9.45d,  //Forward Origin
            0.0d,  //Backward Origin

...
namespace GSF.Settings.Aegis_Medium_Beam_Base
{
    //"Aegis_Medium_Beam_Base == AMBB"
    /// <summary>
    ...
    /// </summary>
    public static class AMBB_Default_Settings
    {

        public static BeamWeaponDefaultInfo Aegis_Medium_Beam_Base = new BeamWeaponDefaultInfo(
    ...
    /// </summary>
    public static class AMBB_Color_Settings
    {
        public static BeamWeaponColorInfo Aegis_Medium_Beam_Base = new BeamWeaponColorInfo(
    ...
    /// </summary>
    public static class AMBB_Heat_Settings
    {
        public static BeamWeaponExtendedHeatInfo Aegis_Medium_Beam_Base = new BeamWeaponExtendedHeatInfo(
    ...
    /// 
    /// </summary>
    public static class AMBB_Default_Ui_Settings
    {

        public static BeamWeaponUiInfo Aegis_Medium_Beam_Base = new BeamWeaponUiInfo(
    ...
    /// </summary>
    public static class AMBB_Custom_Ui_Settings
    {
        public class Toggle
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponToggle AMBB_PowerOveride = new BeamWeaponCustomUiInfo.BeamWeaponToggle(
        ...
        public class Slider
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider AMBB_RangeSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider AMBB_CurrentSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider AMBB_ModulationSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider AMBB_PowerSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
    ...
    /// </summary>
    public static class AMBB_Barrel_Settings
    {
        public static class Aegis_Medium_Beam_Base
        {
        ...
        public static class AMBB_Targeting_Beam
        {

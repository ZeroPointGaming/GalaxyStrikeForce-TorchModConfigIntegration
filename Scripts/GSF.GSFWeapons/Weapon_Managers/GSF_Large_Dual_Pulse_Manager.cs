...
namespace GSF.Settings.Large_Dual_Pulse
{
    //"Large_Dual_Pulse == LDP"
    /// <summary>
    ...
    /// </summary>
    public static class LDP_Default_Settings
    {

        public static BeamWeaponDefaultInfo Large_Dual_Pulse = new BeamWeaponDefaultInfo(
    ...
    /// </summary>
    public static class LDP_Color_Settings
    {
        public static BeamWeaponColorInfo Large_Dual_Pulse = new BeamWeaponColorInfo(
    ...
    /// </summary>
    public static class LDP_Heat_Settings
    {
        public static BeamWeaponExtendedHeatInfo Large_Dual_Pulse = new BeamWeaponExtendedHeatInfo(
    ...
    /// 
    /// </summary>
    public static class LDP_Default_Ui_Settings
    {

        public static BeamWeaponUiInfo Large_Dual_Pulse = new BeamWeaponUiInfo(
    ...
    /// </summary>
    public static class LDP_Custom_Ui_Settings
    {
        public class Toggle
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponToggle LDP_PowerOveride = new BeamWeaponCustomUiInfo.BeamWeaponToggle(
        ...
        public class Slider
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider LDP_RangeSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider LDP_CurrentSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider LDP_ModulationSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider LDP_PowerSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
    ...
    /// </summary>
    public static class LDP_Barrel_Settings
    {
        public static class Large_Dual_Pulse
    {
            //Left Beam
        ...
        public static class LDP_Targeting_Beam
        {

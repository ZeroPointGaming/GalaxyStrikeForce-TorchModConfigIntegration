...
namespace GSF.Settings.Medium_Static_Pulse_Large
{
    //"Medium_Static_Pulse_Large == MSPL"
    /// <summary>
    ...
    /// </summary>
    public static class MSPL_Default_Settings
    {

        public static BeamWeaponDefaultInfo Medium_Static_Pulse_Large = new BeamWeaponDefaultInfo(
    ...
    /// </summary>
    public static class MSPL_Color_Settings
    {
        public static BeamWeaponColorInfo Medium_Static_Pulse_Large = new BeamWeaponColorInfo(
    ...
    /// </summary>
    public static class MSPL_Heat_Settings
    {
        public static BeamWeaponExtendedHeatInfo Medium_Static_Pulse_Large = new BeamWeaponExtendedHeatInfo(
        20000f, //Max Residual Heat  " The Total ammount of heat a turret will accumulate before it begins the cooldown process "
        500f, 	//maxHeat   " The Total ammount of heat a turret can accumulate per Volley "

        5f,    //Residual Heat Per Tick " The ammount of residual heat a turret will accumulate per tick "
        ...
        100,	    //heatDissipationDelay " the ammount of time it will take before the turret will start disipateing volley heat "
    ...
    /// </summary>
    public static class MSPL_Default_Ui_Settings
    {

        public static BeamWeaponUiInfo Medium_Static_Pulse_Large = new BeamWeaponUiInfo(
            ...
            false,  //Target Characters Value
            false,  //Control Panel
            false,  //Toolbar Config 

            false,  //Target Neutrals Value
            false,  //Control Panel
            false,  //Toolbar Config 
    ...
    /// </summary>
    public static class MSPL_Custom_Ui_Settings
    {
        public class Toggle
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponToggle MSPL_PowerOveride = new BeamWeaponCustomUiInfo.BeamWeaponToggle(
        ...
        public class Slider
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider MSPL_RangeSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider MSPL_CurrentSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider MSPL_ModulationSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider MSPL_PowerSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
    ...
    /// </summary>
    public static class MSPL_Barrel_Settings
    {
        public static class Medium_Static_Pulse_Large
        {
        ...
        public static class MSPL_Targeting_Beam
        {

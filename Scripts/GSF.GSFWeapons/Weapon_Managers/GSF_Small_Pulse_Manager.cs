...
namespace GSF.Settings.Small_Pulse
{
    //"Small_Pulse == SP"
    /// <summary>
    ...
    /// </summary>
    public static class SP_Default_Settings
    {

        public static BeamWeaponDefaultInfo Small_Pulse = new BeamWeaponDefaultInfo(
    ...
    /// </summary>
    public static class SP_Color_Settings
    {
        public static BeamWeaponColorInfo Small_Pulse = new BeamWeaponColorInfo(
    ...
    /// </summary>
    public static class SP_Heat_Settings
    {
        public static BeamWeaponExtendedHeatInfo Small_Pulse = new BeamWeaponExtendedHeatInfo(
    ...
    /// </summary>
    public static class SP_Default_Ui_Settings
    {

        public static BeamWeaponUiInfo Small_Pulse = new BeamWeaponUiInfo(
    ...
    /// </summary>
    public static class SP_Custom_Ui_Settings
    {
        public class Toggle
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponToggle SP_PowerOveride = new BeamWeaponCustomUiInfo.BeamWeaponToggle(
        ...
        public class Slider
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider SP_RangeSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider SP_CurrentSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider SP_ModulationSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider SP_PowerSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
    ...
    /// </summary>
    public static class SP_Barrel_Settings
    {
        public static class Small_Pulse
        {
        ...
        public static class SP_Targeting_Beam
        {

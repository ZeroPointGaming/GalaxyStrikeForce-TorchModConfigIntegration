...
/// </summary>
namespace GSF.Settings.Large_Static_Small_Beam
{
    //"Large_Static_Small_Beam == LSSB"
    /// <summary>
    ...
    /// </summary>
    public static class LSSB_Default_Settings
    {

        public static BeamWeaponDefaultInfo Large_Static_Small_Beam = new BeamWeaponDefaultInfo(
    ...
    /// </summary>
    public static class LSSB_Color_Settings
    {
        public static BeamWeaponColorInfo Large_Static_Small_Beam = new BeamWeaponColorInfo(
    ...
    /// </summary>
    public static class LSSB_Heat_Settings
    {
        public static BeamWeaponExtendedHeatInfo Large_Static_Small_Beam = new BeamWeaponExtendedHeatInfo(
    ...
    /// </summary>
    public static class LSSB_Default_Ui_Settings
    {

        public static BeamWeaponUiInfo Large_Static_Small_Beam = new BeamWeaponUiInfo(
    ...
    /// </summary>
    public static class LSSB_Custom_Ui_Settings
    {
        public class Toggle
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponToggle LSSB_PowerOveride = new BeamWeaponCustomUiInfo.BeamWeaponToggle(
        ...
        public class Slider
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider LSSB_RangeSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider LSSB_CurrentSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider LSSB_ModulationSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider LSSB_PowerSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
    ...
    /// </summary>
    public static class LSSB_Barrel_Settings
    {
        public static class Large_Static_Small_Beam
        {

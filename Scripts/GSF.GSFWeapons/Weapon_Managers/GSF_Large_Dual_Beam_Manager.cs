...
namespace GSF.Settings.Large_Dual_Beam
{
    //"Large_Dual_Beam == LDB"
    /// <summary>
    ...
    /// </summary>
    public static class LDB_Default_Settings
    {

        public static BeamWeaponDefaultInfo Large_Dual_Beam = new BeamWeaponDefaultInfo(
    ...
    /// </summary>
    public static class LDB_Color_Settings
    {
        public static BeamWeaponColorInfo Large_Dual_Beam = new BeamWeaponColorInfo(
    ...
    /// </summary>
    public static class LDB_Heat_Settings
    {
        public static BeamWeaponExtendedHeatInfo Large_Dual_Beam = new BeamWeaponExtendedHeatInfo(
    ...
    /// 
    /// </summary>
    public static class LDB_Default_Ui_Settings
    {

        public static BeamWeaponUiInfo Large_Dual_Beam = new BeamWeaponUiInfo(
    ...
    /// </summary>
    public static class LDB_Custom_Ui_Settings
    {
        public class Toggle
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponToggle LDB_PowerOveride = new BeamWeaponCustomUiInfo.BeamWeaponToggle(
        ...
        public class Slider
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider LDB_RangeSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider LDB_CurrentSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider LDB_ModulationSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider LDB_PowerSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
    ...
    /// </summary>
    public static class LDB_Barrel_Settings
    {
        public static class Large_Dual_Beam
        {
            //Left Beam
            public static BeamWeaponBarrelSubpartInfo B1 = new BeamWeaponBarrelSubpartInfo(
            22.5d,  //Forward Origin
        ...
        public static class LDB_Targeting_Beam
        {

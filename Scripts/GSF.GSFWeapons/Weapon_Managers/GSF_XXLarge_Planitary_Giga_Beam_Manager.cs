...
namespace GSF.Settings.XXLarge_Planitary_GigaBeam
{
    //"XXLarge_Planitary_Giga_Beam == XXLPGB"
    /// <summary>
    ...
    /// </summary>
    public static class XXLPGB_Default_Settings
    {

        public static BeamWeaponDefaultInfo XXLarge_Planitary_GigaBeam = new BeamWeaponDefaultInfo(
    ...
    /// </summary>
    public static class XXLPGB_Color_Settings
    {
        public static BeamWeaponColorInfo XXLarge_Planitary_GigaBeam = new BeamWeaponColorInfo(
    ...
    /// </summary>
    public static class XXLPGB_Heat_Settings
    {
        public static BeamWeaponExtendedHeatInfo XXLarge_Planitary_GigaBeam = new BeamWeaponExtendedHeatInfo(
    ...
    /// 
    /// </summary>
    public static class XXLPGB_Default_Ui_Settings
    {

        public static BeamWeaponUiInfo XXLarge_Planitary_GigaBeam = new BeamWeaponUiInfo(
    ...
    /// </summary>
    public static class XXLPGB_Custom_Ui_Settings
    {
        public class Toggle
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponToggle XXLPGB_PowerOveride = new BeamWeaponCustomUiInfo.BeamWeaponToggle(
        ...
        public class Slider
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider XXLPGB_RangeSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider XXLPGB_CurrentSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider XXLPGB_ModulationSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider XXLPGB_PowerSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
    ...
    /// </summary>
    public static class XXLPGB_Barrel_Settings
    {
        public static class XXLarge_Planitary_GigaBeam
        {
        ...
        public static class XXLPGB_Targeting_Beam
        {

...
namespace GSF.Settings.Interior_Pulse
{

    // This weapon should not have the option to deal shield damage, This will require a new meathod for creating the custom UI for every weapon,
    // and i will have to tell the beam code not to draw the second beam and not give you the second color option.
    //"Interior_Pulse == IP"
    /// <summary>
    ...
    /// </summary>
    public static class IP_Default_Settings 
    {

        public static BeamWeaponDefaultInfo Interior_Pulse = new BeamWeaponDefaultInfo(
    ...
    /// </summary>
    public static class IP_Color_Settings
    {
        public static BeamWeaponColorInfo Interior_Pulse = new BeamWeaponColorInfo(
    ...
    /// </summary>
    public static class IP_Heat_Settings
    {
        public static BeamWeaponExtendedHeatInfo Interior_Pulse = new BeamWeaponExtendedHeatInfo(
    ...
    /// 
    /// </summary>
    public static class IP_Default_Ui_Settings
    {

        public static BeamWeaponUiInfo Interior_Pulse = new BeamWeaponUiInfo(
    ...
    /// </summary>
    public static class IP_Custom_Ui_Settings
    {
        public class Toggle
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponToggle IP_PowerOveride = new BeamWeaponCustomUiInfo.BeamWeaponToggle(
        ...
        public class Slider
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider IP_RangeSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider IP_CurrentSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider IP_ModulationSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider IP_PowerSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
    ...
    /// </summary>
    public static class IP_Barrel_Settings
    {
        public static class Interior_Pulse
        {
        ...
        public static class IP_Targeting_Beam
        {

...
namespace GSF.Settings.Aegis_Large_Beam_Base
{
    //"Aegis_Large_Beam_Base == ALBB"
    /// <summary>
    ...
    /// </summary>
    public static class ALBB_Default_Settings
    {

        public static BeamWeaponDefaultInfo AegisLargeBeamBase = new BeamWeaponDefaultInfo(
    ...
    /// </summary>
    public static class ALBB_Color_Settings
    {
        public static BeamWeaponColorInfo AegisLargeBeamBase = new BeamWeaponColorInfo(
    ...
    /// </summary>
    public static class ALBB_Heat_Settings
    {
        public static BeamWeaponExtendedHeatInfo AegisLargeBeamBase = new BeamWeaponExtendedHeatInfo(
    ...
    /// 
    /// </summary>
    public static class ALBB_Default_Ui_Settings
    {

        public static BeamWeaponUiInfo AegisLargeBeamBase = new BeamWeaponUiInfo(
    ...
    /// </summary>
    public static class ALBB_Custom_Ui_Settings
    {
        public class Toggle
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponToggle ALBB_PowerOveride = new BeamWeaponCustomUiInfo.BeamWeaponToggle(
        ...
        public class Slider
        {
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider ALBB_RangeSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider ALBB_CurrentSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider ALBB_ModulationSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
            ...
            public static BeamWeaponCustomUiInfo.BeamWeaponSlider ALBB_PowerSlider = new BeamWeaponCustomUiInfo.BeamWeaponSlider(
    ...
    /// </summary>
    public static class ALBB_Barrel_Settings
    {
        public static class AegisLargeBeamBase
        {
            public static BeamWeaponBarrelSubpartInfo B1 = new BeamWeaponBarrelSubpartInfo(
            11.45d,  //Forward Origin
            ...
            public static BeamWeaponBarrelSubpartInfo B5 = new BeamWeaponBarrelSubpartInfo(
            11.45d,  //Forward Origin
            0.0d,  //Backward Origin
            0.0d,  //Left Origin
            0.0d,  //Right Origin
            ...
            public static BeamWeaponBarrelSubpartInfo B6 = new BeamWeaponBarrelSubpartInfo(
            11.45d,  //Forward Origin
            0.0d,  //Backward Origin
            0.0d,  //Left Origin
            0.0d,  //Right Origin
